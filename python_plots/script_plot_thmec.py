...
plt.plot(thrm_data[xaxis],  thrm_data["mech_trsf_tot"],     '-',  c='black', alpha=1.0, linewidth=3.0, markeredgecolor='none',markersize=msize,label='tot'   )
plt.plot(thrm_data[xaxis], -thrm_data["mech_trsf_tot"],     '--', c='black', alpha=1.0, linewidth=3.0, markeredgecolor='none',markersize=msize,              )
plt.plot(thrm_data[xaxis],  thrm_data["mech_trsf_n_chem"]  + thrm_data["mech_trsf_i_chem"]  + thrm_data["mech_trsf_e_chem"], '-',  c='red',   alpha=1.0, linewidth=1.0, markeredgecolor='none',markersize=msize,label='chem'  )
plt.plot(thrm_data[xaxis], -thrm_data["mech_trsf_n_chem"]  - thrm_data["mech_trsf_i_chem"]  - thrm_data["mech_trsf_e_chem"], '--', c='red',   alpha=1.0, linewidth=1.0, markeredgecolor='none',markersize=msize,              )
plt.plot(thrm_data[xaxis],  thrm_data["mech_trsf_n_compr"] + thrm_data["mech_trsf_i_compr"] + thrm_data["mech_trsf_e_compr"],'-',  c='blue',  alpha=1.0, linewidth=1.0, markeredgecolor='none',markersize=msize,label='compr' )
plt.plot(thrm_data[xaxis], -thrm_data["mech_trsf_n_compr"] - thrm_data["mech_trsf_i_compr"] - thrm_data["mech_trsf_e_compr"],'--', c='blue',  alpha=1.0, linewidth=1.0, markeredgecolor='none',markersize=msize,              )
plt.plot(thrm_data[xaxis],  thrm_data["mech_trsf_n_visc"]  + thrm_data["mech_trsf_i_visc"]  + thrm_data["mech_trsf_e_visc"], '-',  c='green', alpha=1.0, linewidth=1.0, markeredgecolor='none',markersize=msize,label='visc'  )
plt.plot(thrm_data[xaxis], -thrm_data["mech_trsf_n_visc"]  - thrm_data["mech_trsf_i_visc"]  - thrm_data["mech_trsf_e_visc"], '--', c='green', alpha=1.0, linewidth=1.0, markeredgecolor='none',markersize=msize,              )
plt.legend(loc='upper right', borderaxespad=0., fontsize=tsize)

plt.xlabel(xlabel, fontsize=tsize)
plt.ylabel('mechanical rates (erg cm$^{-3}$ s$^{-1}$)', fontsize=tsize)
...
plt.plot(thrm_data[xaxis], thrm_data["chem_DE_tot"], '-',  c='black', alpha=1.0, linewidth=2.0, markeredgecolor='none',markersize=msize,label='tot')
plt.plot(thrm_data[xaxis],-thrm_data["chem_DE_tot"], '--', c='black', alpha=1.0, linewidth=2.0, markeredgecolor='none',markersize=msize            )
plt.plot(thrm_data[xaxis], thrm_data["chem_DE_n_phgrn"]   + thrm_data["chem_DE_i_phgrn"]   + thrm_data["chem_DE_e_phgrn"],   '-', c='red',     alpha=1.0, linewidth=1.0, markeredgecolor='none',markersize=msize,label='phel')
plt.plot(thrm_data[xaxis],-thrm_data["chem_DE_n_phgrn"]   - thrm_data["chem_DE_i_phgrn"]   - thrm_data["chem_DE_e_phgrn"],   '-', c='red',     alpha=1.0, linewidth=1.0, markeredgecolor='none',markersize=msize,            )
plt.plot(thrm_data[xaxis], thrm_data["chem_DE_n_phgas"]   + thrm_data["chem_DE_i_phgas"]   + thrm_data["chem_DE_e_phgas"],   '-', c='blue',    alpha=1.0, linewidth=1.0, markeredgecolor='none',markersize=msize,label='phch')
plt.plot(thrm_data[xaxis],-thrm_data["chem_DE_n_phgas"]   - thrm_data["chem_DE_i_phgas"]   - thrm_data["chem_DE_e_phgas"],   '-', c='blue',    alpha=1.0, linewidth=1.0, markeredgecolor='none',markersize=msize,            )
plt.plot(thrm_data[xaxis], thrm_data["chem_DE_n_diss_H2"] + thrm_data["chem_DE_i_diss_H2"] + thrm_data["chem_DE_e_diss_H2"], '-', c='orange',  alpha=1.0, linewidth=1.0, markeredgecolor='none',markersize=msize,label='diss')
plt.plot(thrm_data[xaxis],-thrm_data["chem_DE_n_diss_H2"] - thrm_data["chem_DE_i_diss_H2"] - thrm_data["chem_DE_e_diss_H2"], '-', c='orange',  alpha=1.0, linewidth=1.0, markeredgecolor='none',markersize=msize,            )
plt.plot(thrm_data[xaxis], thrm_data["chem_DE_n_cosmic"]  + thrm_data["chem_DE_i_cosmic"]  + thrm_data["chem_DE_e_cosmic"],  '-', c='green',   alpha=1.0, linewidth=1.0, markeredgecolor='none',markersize=msize,label='cosm')
plt.plot(thrm_data[xaxis],-thrm_data["chem_DE_n_cosmic"]  - thrm_data["chem_DE_i_cosmic"]  - thrm_data["chem_DE_e_cosmic"],  '-', c='green',   alpha=1.0, linewidth=1.0, markeredgecolor='none',markersize=msize,            )
plt.plot(thrm_data[xaxis], thrm_data["chem_DE_n_other"]   + thrm_data["chem_DE_i_other"]   + thrm_data["chem_DE_e_other"],  '-',  c='magenta', alpha=1.0, linewidth=1.0, markeredgecolor='none',markersize=msize,label='othr')
plt.plot(thrm_data[xaxis],-thrm_data["chem_DE_n_other"]   - thrm_data["chem_DE_i_other"]   - thrm_data["chem_DE_e_other"],  '-',  c='magenta', alpha=1.0, linewidth=1.0, markeredgecolor='none',markersize=msize,            )
plt.legend(loc='upper right', borderaxespad=0., fontsize=tsize)

plt.xlabel(xlabel, fontsize=tsize)
plt.ylabel('chem rates (erg cm$^{-3}$ s$^{-1}$)', fontsize=tsize)
