...
# 3 - read data                              
# -------------------------------------------
fH2 = open('H2_line.out','r')
H2_names = fH2.readline().split()
H2_lines = fH2.readlines()
...
for H2_name in H2_names:
   H2_data[H2_name] = np.ma.zeros(len(H2_lines), 'f', fill_value = -999.999)

for (line_count, line) in enumerate(H2_lines):
    items = line.split()
    for (col_count, col_name) in enumerate(H2_names):
        value = items[col_count]
...
plt.plot(thrm_data[xaxis],  thrm_data["line_rad_n_H2"] + thrm_data["line_rad_i_H2"] + thrm_data["line_rad_e_H2"], '-',  c='black',   alpha=1.0, linewidth=3.0, markeredgecolor='none',markersize=msize,label='H2'      )
plt.plot(thrm_data[xaxis], -thrm_data["line_rad_n_H2"] - thrm_data["line_rad_i_H2"] - thrm_data["line_rad_e_H2"], '--', c='black',   alpha=1.0, linewidth=3.0, markeredgecolor='none',markersize=msize                 )
plt.plot(thrm_data[xaxis],  thrm_data["line_rad_n_H2"],                                                           '-',  c='blue',    alpha=1.0, linewidth=1.0, markeredgecolor='none',markersize=msize,label='n'       )
plt.plot(thrm_data[xaxis], -thrm_data["line_rad_n_H2"],                                                           '--', c='blue',    alpha=1.0, linewidth=1.0, markeredgecolor='none',markersize=msize,                )
plt.plot(thrm_data[xaxis],  thrm_data["line_rad_i_H2"],                                                           '-',  c='red',     alpha=1.0, linewidth=1.0, markeredgecolor='none',markersize=msize,label='i'       )
plt.plot(thrm_data[xaxis], -thrm_data["line_rad_i_H2"],                                                           '--', c='red',     alpha=1.0, linewidth=1.0, markeredgecolor='none',markersize=msize,                )
plt.plot(thrm_data[xaxis],  thrm_data["line_rad_e_H2"],                                                           '-',  c='green',   alpha=1.0, linewidth=1.0, markeredgecolor='none',markersize=msize,label='e'       )
plt.plot(thrm_data[xaxis], -thrm_data["line_rad_e_H2"],                                                           '--', c='green',   alpha=1.0, linewidth=1.0, markeredgecolor='none',markersize=msize,                )
plt.legend(loc='upper right', borderaxespad=0., fontsize=tsize)
...
plt.plot(thrm_data[xaxis],  thrm_data["line_rad_n_H2"], '-',  c='black',alpha=1.0, linewidth=3.0, markeredgecolor='none',markersize=msize,label='n'       )
plt.plot(thrm_data[xaxis], -thrm_data["line_rad_n_H2"], '--', c='black',alpha=1.0, linewidth=3.0, markeredgecolor='none',markersize=msize,                )
plt.plot(H2_data[xaxis],   -H2_data["total_H2_em"],     '-',  c='blue', alpha=1.0, linewidth=1.0, markeredgecolor='none',markersize=msize,label='I'       )
plt.plot(H2_data[xaxis],    H2_data["total_H2_em"],     '--', c='blue', alpha=1.0, linewidth=1.0, markeredgecolor='none',markersize=msize,                )
plt.plot(H2_data[xaxis],    H2_data["h2excit_n_coh"],   '-',  c='red',  alpha=1.0, linewidth=1.0, markeredgecolor='none',markersize=msize,label='coh'       )
plt.plot(H2_data[xaxis],   -H2_data["h2excit_n_coh"],   '--', c='red',  alpha=1.0, linewidth=1.0, markeredgecolor='none',markersize=msize,                )
plt.legend(loc='upper right', borderaxespad=0., fontsize=tsize)
...
plt.plot(thrm_data[xaxis],  thrm_data["line_rad_e_H2"], '-',  c='black',alpha=1.0, linewidth=3.0, markeredgecolor='none',markersize=msize,label='n'       )
plt.plot(thrm_data[xaxis], -thrm_data["line_rad_e_H2"], '--', c='black',alpha=1.0, linewidth=3.0, markeredgecolor='none',markersize=msize,                )
plt.plot(H2_data[xaxis],    H2_data["h2excit_e_add"],   '-',  c='blue', alpha=1.0, linewidth=1.0, markeredgecolor='none',markersize=msize,label='I'       )
plt.plot(H2_data[xaxis],   -H2_data["h2excit_e_add"],   '--', c='blue', alpha=1.0, linewidth=1.0, markeredgecolor='none',markersize=msize,                )
plt.plot(H2_data[xaxis],    H2_data["h2excit_e_LW"],    '-',  c='red',  alpha=1.0, linewidth=1.0, markeredgecolor='none',markersize=msize,label='coh'       )
plt.plot(H2_data[xaxis],   -H2_data["h2excit_e_LW"],    '--', c='red',  alpha=1.0, linewidth=1.0, markeredgecolor='none',markersize=msize,                )
plt.legend(loc='upper right', borderaxespad=0., fontsize=tsize)
