...
plt.plot(chem_data[xaxis], chem_data["x(S+)"],      '-', c='magenta',alpha=1.0, markeredgecolor='none',markersize=msize,label='x(S$^+$)')
...
plt.plot(chem_data[xaxis], chem_data["x(HCO+)"],    '-', c='gold',   alpha=1.0, markeredgecolor='none',markersize=msize,label='x(HCO$^+$)')
