...
class SAMPHubServer(object):
  ...
  def __init__(self, secret = None, addr=None, port=0, lockfile=None, timeout = 0, \
               ...
               cert_reqs = 0, ca_certs = None, ssl_version = ssl.PROTOCOL_TLSv1, web_profile = False):
    """
    ...
    specified the default SSL version is  L{ssl.PROTOCOL_TLSv1}. This version provides the most
    compatibility with other versions client side. Other SSL protocol versions are:                        
    L{ssl.PROTOCOL_TLSv1}.
  ...
  def _new_lockfile(self, lockfilename):
    ...
    if SSL_SUPPORT and self._https:
      ...
      ssl_protocol_types = {ssl.PROTOCOL_TLSv1: "TLSv1"}
      lockfile.write(
        "hub.ssl.protocol = {}\n".format(
          ssl_protocol_types.get(self._ssl_version,
                                 'unknown protocol')))
...
class SAMPClient(object):
  ...
  def __init__(self, hub, metadata = None, addr = None, port = 0,
               ...
               ca_certs=None, ssl_version=ssl.PROTOCOL_TLSv1, callable = True):
    """
...
def main():
  ...
  if SSL_SUPPORT:
    ...
    ssl_group.add_option("--ssl-version", dest = "ssl_version", metavar = "STRING",
                         ...
                         "If not specified the default SSL version is TLSv1. This version " \
                         "provides the most compatibility with other versions client side. " \
                         "Other SSL protocol versions are: TLSv1.",
                         type = "choice", choices = ["", "", "", "TLSv1"])
    ...
    parser.set_defaults(ssl_version = "TLSv1")
